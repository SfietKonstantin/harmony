...
openssl x509 -req -days 365 -in harmony-ca.csr -signkey harmony-ca.key -out harmony-ca.crt -passin pass:harmony-ca-key
...
openssl x509 -req -days 365 -in harmony.csr -signkey harmony.key -out harmony.crt -passin pass:harmony-key
